  ...
  ar: {
    ...
    body: String.raw`
      ...
      <ol style="margin-left:1.25rem;">
        <li><strong>تعريف الميزات</strong> في علامة <strong>Features</strong> للمنتج (<code>…/features</code>).</li>
      ...
      <ul style="margin-left:1.25rem;">
        ...
        <li><strong>Create Feature</strong> — يضيف صفاً لجدول قابل للبحث مع تاريخ الإنشاء وقائمة الإجراءات.</li>
      ...
      \${screenshot('platform-product-entitlement-sets.png', 'علامة Entitlement Sets: تجميع الميزات في مجموعات قابلة لإعادة الاستخدام مرتبطة بالإصدارات')}
      ...
      <p>\${link('/sdk/features-usage', 'SDK: الميزات والاستخدام')} · \${link('/api/catalog', 'REST catalog')} · \${link('/guides/platform/licenses', 'التراخيص (البائع)')} · \${link('/guides/platform/products', 'المنتجات')}</p>
    `,
  },
  fr: {
    title: 'Fonctionnalités & jeux de droits',
    lead:
      'Définissez capacités, regroupez-les en SKU, assignez jeux aux licences et appliquez-les dans le SDK à l\'exécution.',
    body: String.raw`
      ...
      <ul style="margin-left:1.25rem;">
        ...
        <li><strong>Suivi usage</strong> — compteurs optionnels envoyés aux routes télémétrie (\${link('/api/telemetry', 'Telemetry API')}).</li>
      </ul>
