...
@Component({
  selector: 'app-sdk-wpf',
  standalone: true,
  template: `
    <div class="doc-page">
      <h1>WPF Integration</h1>
      <p class="lead">Add license validation to WPF applications.</p>
      <h2>Setup</h2>
      <p>Reference the SDK and validate licenses before showing the main window.</p>
    </div>
  `,
