...
@Component({
  selector: 'app-sdk-winforms',
  standalone: true,
  template: `
    <div class="doc-page">
      <h1>WinForms Integration</h1>
      <p class="lead">Add license validation to Windows Forms applications.</p>
      <h2>Setup</h2>
      <p>Reference the SDK and add license validation on application startup.</p>
    </div>
  `,
...
export class SdkWinformsComponent {}
