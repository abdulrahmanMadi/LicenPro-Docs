...
@Component({
  selector: 'app-perpetual-license',
  standalone: true,
  template: `
    <div class="doc-page">
      <h1>Perpetual License</h1>
      <p class="lead">One-time purchase licenses with lifetime access.</p>
      <h2>Overview</h2>
      <p>A perpetual license grants the customer permanent access to your software with a single payment.</p>
      <h2>Features</h2>
      <ul>
        <li>No expiration date</li>
        <li>Optional maintenance period for updates</li>
        <li>Can be transferred between machines</li>
      </ul>
    </div>
  `,
...
export class PerpetualLicenseComponent {}
