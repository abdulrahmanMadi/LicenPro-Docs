...
@Component({
  selector: 'app-trial-license',
  standalone: true,
  template: `
    <div class="doc-page">
      <h1>Trial License</h1>
      <p class="lead">Time-limited evaluation licenses for potential customers.</p>
      <h2>Overview</h2>
      <p>Trial licenses allow users to evaluate your software before purchasing.</p>
      <h2>Features</h2>
      <ul>
        <li>Configurable duration (days)</li>
        <li>Feature restrictions</li>
        <li>One-time use per machine</li>
      </ul>
    </div>
  `,
